  ...
  const FetchApiData= async()=>{
    try {
      setIsLoading(true)
        ...
        if(status===200){
            setVideoData(data.data["Sales Ads"])
        }
  ...
  return (
    <>
    {
      showHeader && (
        ...
        <Text style={[styles.showMoreText,{fontSize:20,borderBottomWidth:1,borderColor:"#FFF"}]}>Sales Add</Text>
    </View>
      )
    }
