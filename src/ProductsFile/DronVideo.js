    ...
    try {
      setIsLoading(true)
        ...
        if(status===200){
            ...
            setVideoData(data.data["DRONE VIDEOS"])  
  ...
  return (
    ...
    
    {
      ...
      <View style={{alignItems:"center",marginTop:40,marginBottom:20}}>
        <Text style={[styles.showMoreText,{fontSize:20,borderBottomWidth:1,borderColor:"#FFF"}]}>DRON VIDEO</Text>
    </View>
    </>
      )
    }
